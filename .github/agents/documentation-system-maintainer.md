...
description: Maintains the development-system documentation set including consistency across layers, no double-truth, clean routing of content to the right document types, and controlled updates with explicit evidence and escalation.
---
